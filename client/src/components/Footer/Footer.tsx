...
const iconpropertiesremovelater = {
    display:{ 
        xs: 'none', // 0
        sm: 'initial', // 600
        md: 'initial', // 900
...
const Footer = () => {
    ...
    <ul className={s.iconsDIV}>
        <a href='https://www.facebook.com/luis.lesniewicz' target='_blank' rel="noreferrer noopener"><li><WhatsAppIcon sx={iconproperties}/></li></a>
        <a href='https://www.facebook.com/luis.lesniewicz' target='_blank' rel="noreferrer noopener"><li><FacebookIcon sx={iconpropertiesremovelater}/></li></a>
        ...
        <a href='https://www.facebook.com/luis.lesniewicz' target='_blank' rel="noreferrer noopener"><li><TwitterIcon sx={iconpropertiesremovelater}/></li></a>
